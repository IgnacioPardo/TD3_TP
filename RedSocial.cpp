...
RedSocial::Usuario::Usuario(int id_, string alias_){
...
string RedSocial::Usuario::obtener_alias() const{
	//Post: Devuelve el alias del Usuario
	return this->_alias;
}

int RedSocial::Usuario::obtener_id() const{
	//Post: Devuelve el id del Usuario
	return this->_id;
}


void RedSocial::Usuario::amigar_usuario(Usuario *usr){
...
void RedSocial::Usuario::desamigar_usuario(Usuario *usr){
...
void RedSocial::Usuario::desamigar_todos(){
...
const set<string> & RedSocial::Usuario::obtener_amigos() const{
	//Post: Devuelve por referencia el conjunto de los alias de los amigos
	
	return this->_alias_amigos;
}

int RedSocial::Usuario::cantidad_amigos() const{
